...
//	  		필드마다 붙여야함. 필드가 10개이면 10개의 @Autowired가 필요함, 자주 안씀.
		@Autowired
		private Board myBoard;	//반환타입이 Board인 bean을 찾아서 가져와서 myBoard에 주입 -> DI(dependency injection)
	
	
	
	/*
	 * 2. 생성자에 @Autowired지정하기
	 * 		생성자에는 @Autowired 생략해도된다.
	...
	*/
	...
	/*
	 * 3.setter에 @Autowired지정하기
	 * @Autowired를 꼭 적어야한다.
	 * setter 메소드명을 마음대로 작성해도 된다.
	private Board myBoard;
	@Autowired	//생략할 수 없다. 꼭 적어야함
	public void setBoard(Board myBoard) {		//매개변수로 자동 주입힌다.
